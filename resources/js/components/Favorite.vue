<template>
    <span :class="classes" @click="toggle">
        ...
        <span class="absolute right-0">
            <svg v-if="isFavorited" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6" >
                                <path
...
export default {
    ...
    computed: {
        classes() {
            return [this.isFavorited ? 'text-red-500' : 'text-gray-500']
        }
    },
